...
if (isset($_SESSION["username"]) && isset($_SESSION["type"]))
{
	...
	try
	{
		...
		$stmt = $pdo->prepare("SELECT * FROM Matches where `MatchId` = :id ");
			...
			<div class="row">
			  ...
			  <div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
				  ...
				  <div class="x_content">
					<br />
					<form class="form-horizontal form-label-left" action="edit.php" method="POST">


					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-3">MatchId</label>
						<div class="col-md-9 col-sm-9 col-xs-9">
						  <input type="text" class="form-control" name="Matchid" value=<?php echo $id?> readonly>
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-9">
						  <input type="number" class="form-control" name="duration" placeholder="120" value=<?php echo $duration?> required max='300'>
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-3">Location</label>
						<div class="col-md-9 col-sm-9 col-xs-9">
						  <input type="text" class="form-control" name="location" placeholder="The University of Nottingham" value=<?php echo $location?> required maxlength="100">
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-3">Capacity (numbers)</label>
						<div class="col-md-9 col-sm-9 col-xs-9">
						  <input type="number" class="form-control" name="capacity" placeholder="11" value=<?php echo $capacity?> required max="50">
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-3">Information</label>
						<div class="row-md-9 col-md-9 col-sm-9 col-xs-9">
						  <textarea type="text" class="form-control" rows="9" name="information" placeholder="input your information" maxlength="255"><?php echo $information?></textarea>
						</div>
					  </div>
