				  ...
				  <div class="x_content">
					...
					<table class="table table-striped projects">
					  ...
					  <tr>
						...
						<td> <?php print(htmlspecialchars($row['MatchId']));?></td>
						...
						<td>
						  <a href="editmatch.php?id=<?php echo $row['MatchId'];?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
							...
							<div class="modal fade bs-example-modal-sm-<?php echo $count ?>" tabindex="-1" role="dialog" aria-hidden="true">
                    			<div class="modal-dialog modal-sm-<?php echo $count ?>">
                        			...
                        			<div class="modal-body">
                          				<h4>Do you want to delete this match?</h4>
                        			</div>
                        			<div class="modal-footer">
                          				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                          				<a href="deletematch.php?id=<?php echo $row['MatchId'];?>" type="button" class="btn btn-primary">Yes</a>
                       		 		</div>
