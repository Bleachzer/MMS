				...
				<ul class="nav side-menu">
				  ...
				  <li><a><i class="fa fa-edit"></i> Player <span class="fa fa-chevron-down"></span></a>
					<ul class="nav child_menu">
					  <li><a href="match.html">view matches</a></li>
			...
			<div class="row">
			  ...
			  <div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
				  ...
				  <div class="x_content">
					<br />
					<form class="form-horizontal form-label-left" action="modi.php" method="POST">
					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-3">Name</label>
						<div class="col-md-9 col-sm-9 col-xs-9">
						  <input type="text" class="form-control" name="Name" value=<?php echo $name?> required maxlength="60">
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-9">
						  <input type="Email" class="form-control" name="Email" value=<?php echo $email?> required maxlength="100">
						</div>
					  </div>
					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-3">Phone</label>
						<div class="col-md-9 col-sm-9 col-xs-9">
						  <input type="text" class="form-control" name="Phone" value=<?php echo $phone?> required minlength="6" maxlength="50">
						</div>
					  </div>
